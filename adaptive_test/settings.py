...
initial_config_file_path = os.path.join(
    SETTINGS_DIR, '..', 'configuration', 'initial_settings.ini')
local_config_file_path = os.path.join(
    SETTINGS_DIR, '..', 'configuration', 'local_settings.ini')
...
SECRET_KEY = '342*^l2b_b1%xc2o)liyka67&(cr1)a2hl47$rw46=hzvxo-ny'
...
ROOT_URLCONF = 'adaptive_test.urls'
